...
{
    public class GetClassFriendsHandler : IRequestHandler<GetClassFriendsRequestDTO, IEnumerable<GetClassFriendsResponseDTO>>
    {
        ...
        public async Task<IEnumerable<GetClassFriendsResponseDTO>> HandleAsync(GetClassFriendsRequestDTO request, CancellationToken ct)
        {
            ...
            return userInfos.Adapt<IEnumerable<GetClassFriendsResponseDTO>>();
